                                        ...
                                        <div class="card shadow-lg rounded h-100 border-0">
                                            <div class="card-body d-flex flex-column justify-content-between">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <h5 class="card-title mb-2 text-dark note-title">{{ $note->title }}</h5>
                                                </div>
                                                <p class="card-text text-muted">
                                                    <span>Created {{ $note->created_at->diffForHumans() }}</span><br>
                                            ...
                                            <div
                                                class="card-footer bg-white border-0 d-flex justify-content-between gap-2 py-3">
